...
public class SeqTypeConstants {
    ...
    public final static String LOGIN_OK = "101";
    public final static String LOGIN_ALREADY = "102";
    public final static String LOGIN_NO_DATA = "103";
    public final static String LOGIN_IOS = "104";

    public final static String STATE_REQ = "200";
    ...
    public final static String QR_DIFF = "302";
