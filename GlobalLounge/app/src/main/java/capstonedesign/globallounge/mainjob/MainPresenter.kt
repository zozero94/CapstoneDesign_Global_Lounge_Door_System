...
import capstonedesign.globallounge.dto.ADMIN
import capstonedesign.globallounge.dto.STUDENT
import capstonedesign.globallounge.dto.Student
import capstonedesign.globallounge.dto.User
import capstonedesign.globallounge.model.permission.BaseServer.Companion.LOGIN_ALREADY
import capstonedesign.globallounge.model.permission.BaseServer.Companion.LOGIN_NO_DATA
import capstonedesign.globallounge.model.permission.BaseServer.Companion.LOGIN_OK
import capstonedesign.globallounge.model.permission.SejongConnection
import capstonedesign.globallounge.model.permission.ServerConnection
import capstonedesign.globallounge.model.util.AutoLogin
...
class MainPresenter(private val view: MainContract.View, context: Context) : MainContract.Presenter {
     ...
     * @see capstonedesign.globallounge.mainjob.MainActivity.onCreate
     *
     * 자동로그인 체크가 안되있을 시
     ...
     * @see capstonedesign.globallounge.mainjob.MainActivity.onActivityResult
     */
    ...
    /**
     * 서버와의 통신 종료
     * @see capstonedesign.globallounge.mainjob.MainActivity.onPause
     */
