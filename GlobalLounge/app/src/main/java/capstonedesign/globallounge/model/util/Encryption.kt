...
object Encryption {
     ...
     *
     * 서버로 인증 요청하기 전 키 생성
     * @see capstonedesign.globallounge.model.permission.ServerConnection.requestServerPermission
     */
    fun newKey() {
     ...
     * @see capstonedesign.globallounge.mainjob.MainPresenter.approvalPermission
     *
     * @param data : 암호화된 데이터
     *
